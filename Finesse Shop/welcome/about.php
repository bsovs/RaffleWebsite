...
// Check connection
if (!$conn) {
    die("Connection failed: Error FS" );
}
...
<div id="contactus">
<h1>About Us</h1>
<p>Created in 2015 by Brandon Sovran, Finesse Shop offers products for free that people could 
not generally afford.</p>
<p>About Brandon Sovran. </p>
</div>
</div>
</div>
...
<p><br>All rights reserved - Copyright © finesseshop.ca 2015 - Created by @Brandon.Sovran - <a href="about" title="About FinesseShop">About FinesseShop</a> - <a href="contact" title="Contact us">Contact us</a> <p>
</div>
