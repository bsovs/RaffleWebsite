...
<div class="box6">
 <div class="box">
 <img src="gucci-belt" width="460" height="370" style="position:absolute; left:-100px; top:-20px;">
...
height:100px;
font-size:130%;
text-shadow:5px 3px 3px black;">Gucci-Belt<br>Value:$500</div>
  
  <!-- Button -->
  <div id="win">
<form action="http://localhost/Finesse%20Shop/welcome/win" method="post">
...
<div id="tickets">
<form action="http://localhost/Finesse%20Shop/welcome/tickets" method="POST" target="_blank">
