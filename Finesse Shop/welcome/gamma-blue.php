...
<form action="insertcomment4.php" method="post">
...
<div class="box6">
 <div class="box">
 <img src="jordan_gammablue2.png" width="460" height="370" style="position:absolute; left:-140px; top:-20px;">
...
height:100px;
font-size:130%;
text-shadow:5px 3px 3px black;">Air Jordan 11 Retro Gamma Blue<br>Value:$500</div>
  
  <!-- Button -->
  <div id="win">
<form action="http://localhost/Finesse%20Shop/welcome/win4" method="post">
