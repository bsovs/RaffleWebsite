...
<form action="insertcomment2.php" method="post">
...
<div class="box6">
 <div class="box">
 <img src="gucci-belt2" width="460" height="370" style="position:absolute; left:-100px; top:-20px;">
...
text-shadow:5px 3px 3px black;">Gucci-Belt<br>Value:$500</div>
  ...
  <!-- Button -->
  <div id="win">
<form action="http://localhost/Finesse%20Shop/welcome/win2" method="post">
