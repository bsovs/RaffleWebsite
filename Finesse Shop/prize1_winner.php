...
<tr><td class="tr2"><a href="tickets.html"title="Get Tickets">Get Tickets</a></td></tr> 
 ...
 <tr><td class="tr2"><a href="prize1_winner.php"title="Gucci Belts">Gucci Belts</a></td></tr> 
...
$sql = "SELECT username FROM prize1 ORDER BY RAND() LIMIT 1";
$result = mysqli_query($conn, $sql);
 if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
	echo "Winner is: " .$row["username"];
} 
 }
else {
     echo "error";
